...
**Figure 1**. Figure 2. Partial residual plots showing the effect of the single predictor which best explains the variability in species-level reproductive success. A) shows the effect of plant species centrality on the fruit set of each of the plant species considered and B) shows the effect of plant niche overlap on its average number of seeds per fruit. Dots represent each of the individuals sampled for each species within each site.
