...
```
**Figure S3.** Forest plots showing confidence intervals for all coefficients included in species-level models. 
...
```
**Figure S4.** Forest plots showing confidence intervals for all coefficients included in site-level models, A) fruit set, B) number of seeds per fruit and C) fruit and seed weight. 
