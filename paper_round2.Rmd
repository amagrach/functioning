...
Our study was conducted in SW Spain within the area of influence of Doñana National Park (Figure 1). Here, we surveyed 16 Mediterranean woodland patches with an average distance of 7 km between them (min= 3 km, max= 46.5 km). Each site was surveyed 7 times during the flowering season of 2015 (from February to May) following a 100-m x 2 m transect for 30 mins. Along each transect, we identified all plant species and recorded all the flower visitors that legitimately visited them during each 30-min period. In addition, in each round we conducted 3 minutes focal observations of 3 individuals belonging to the 19 most common species totalling X census [give mean per site?](Curro). In addition, unrecorded interactions between plant and pollinators during the sampling were recorded when observed out of the timed periods, as this dificult to observe interactions may be important for defining the network structure. Floral visitors (from now on referred to as pollinators) that could not be identified in the field were captured, stored and identified in the laboratory by FdPM with the aid of experts in the different taxonomic groups (see acknowledgements). All surveys were done under similar weather conditions, avoiding windy or rainy days. [maybe say we tried excluding singletons and analysis do not change?]()
...
[Yet at present we do not know how the interplay between redundancy and complementarity in species roles determines reproductive success.](I don't see where to place this sentence. I like it, but was breaking the flow. Discusion?)
...
_Simulating the effect of community structure as sample size increases_ [no se si le pondria titulo aparte o no, quizas no hace falta, yo o uniria a estatistical analysis]()
