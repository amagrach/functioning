...
When evaluating the effect of differences in community composition and network structure for equity in reproductive success across the different species within a community we find that model 1 is the best model for all the thresholds considered (50^th, 25^th and 75^th percentiles). Here, none of the variables considered are able to explain differences observed in equity across sites (Tables S9, S10, S11).
