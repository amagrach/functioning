...
m3.eq<-glm(no_rows ~  tot.visits.sc + nodf.song.sc + functional.comp.poll.sc, family="gaussian", data=f6)
...
pl.th.fun<-ggplot(f6,  aes(x=functional.comp.poll.sc, y=no_rows))+      
        geom_point(size=4, color="darkgrey") + geom_smooth(method=lm, size=1.5, se=TRUE, color = "black", alpha=0.2) + 
